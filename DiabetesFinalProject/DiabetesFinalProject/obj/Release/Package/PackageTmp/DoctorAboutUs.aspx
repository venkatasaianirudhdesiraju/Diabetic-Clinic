<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="DoctorAboutUs.aspx.cs" Inherits="DiabetesFinalProject.DoctorAboutUs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="buttonsDiv">
        ...
        <asp:Button ID="btnHome" runat="server" Text="Home" PostBackUrl="~/Doctorindex.aspx" Height="45px" Width="85px" />              
    </div>
</asp:Content>
