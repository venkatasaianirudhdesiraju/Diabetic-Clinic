...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="EditDiv">
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="390px" AutoGenerateRows="False" CellPadding="4" CellSpacing="10" DataKeyNames="DoctorId" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
