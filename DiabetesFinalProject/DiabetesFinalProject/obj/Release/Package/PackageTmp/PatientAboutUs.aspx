<%@ Page Title="" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="PatientAboutUs.aspx.cs" Inherits="DiabetesFinalProject.PatientAboutUs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="buttonsDiv">
        ...
        <asp:Button ID="btnHome" runat="server" Text="Home" PostBackUrl="~/Patientindex.aspx" Height="45px" Width="85px" />              
    </div>
</asp:Content>
