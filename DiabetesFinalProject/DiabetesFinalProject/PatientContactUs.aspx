<%@ Page Title="" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="PatientContactUs.aspx.cs" Inherits="DiabetesFinalProject.PatientContactUs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="btnDiv">
        ...
        <asp:Button ID="btnHome" runat="server" Text="Home" Height="45px" Width="75px" CausesValidation="False"  PostBackUrl="~/Patientindex.aspx" />              
    </div>
</asp:Content>
