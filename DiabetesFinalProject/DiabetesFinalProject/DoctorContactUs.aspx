<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.Master" AutoEventWireup="true" CodeBehind="DoctorContactUs.aspx.cs" Inherits="DiabetesFinalProject.DoctorContactUs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="btnDiv">
        ...
        <asp:Button ID="btnHome" runat="server" Text="Home" Height="45px" Width="75px" CausesValidation="False" PostBackUrl="~/Doctorindex.aspx"  />              
    </div>
</asp:Content>
